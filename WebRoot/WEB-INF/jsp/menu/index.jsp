...
<body onload="ini()">
<form action="${pageContext.request.contextPath}/system/elecUserAction_login.action" method="post" >
					...
					<tr>
						...
						<td height="99" width="27%">
									...
									<td>
										<table>
											<tr>
												...
												<td>
													<img src="${pageContext.request.contextPath}/checkNumber.jsp" name="checkNumber" style="cursor:hand" title="点击可更换图片" height="20" onclick="this.src='${pageContext.request.contextPath}/checkNumber.jsp?timestemp='+new Date().getTime()"/>
												</td>
											</tr>
										</table>
									</td>
							...
							<!--	-->
								<tr>
									<td width="100"></td>
									<td width="100"><input type="button" class=btn_mouseout onmouseover="this.className='btn_mouseover'" onmouseout="this.className='btn_mouseout'" value="登   录" name="huifubtn" onclick="check()"></td>
