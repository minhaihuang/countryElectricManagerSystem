...
<script type="text/javascript">
	...
	<body>
		<br>
		<form id="form1" action="${pageContext.request.contextPath}/system/elecUserAction_updateUser.action" method="post">
			...
			<table cellSpacing="1" cellPadding="5" width="620px" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input onblur="checkUnique(this)" id='account' name="account" type="text"  value="<s:property value="account"/>"/>
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:radio name="gender" list="%{#application.dictionary.dictionaryMap.gender}"></s:radio>
						<!--  
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:select  name="units" list="%{#application.dictionary.dictionaryMap.units}">
						</s:select>
						<!--  
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input id="password" name="password" type="password"  value="<s:property value="%{password}"/>"/>
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input name="phone" type="text"   value="<s:property value="%{phone}"/>"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						...
						<s:select name="isDuty" list="%{#application.dictionary.dictionaryMap.isDuty}"></s:select>
						<!--  
